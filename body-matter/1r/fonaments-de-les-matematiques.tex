...
\section{Els fonaments}
    ...
    \begin{proof}
        ...
        \]
        és vertadera.
        Ara bé, per la definició d'\myref{def:implicació} això ho podem escriure com
        \[
    ...
    \end{tautology}
    \begin{proof}
        La relació~\(R\lor(\lnot R)\) és equivalent, per la definició d'\myref{def:implicació}, a~\(R\implica R\).
    ...
    \begin{proof}
        ...
        \]
        és vertadera.
        Ara bé, si~\(R\) és vertadera trobem per la definició de \myref{def:negació} que~\(\lnot R\) és falsa, i aleshores per la tautologia del \myref{taut:R o no R és vertadera} les relacions~\(\lnot(\lnot R)\lor(\lnot R)\) i~\(R\lor(\lnot(\lnot(\lnot R))\) són vertaderes
    ...
    \begin{proof}
        ...
        \]
        és vertadera.
        Aleshores, per la tautologia del \myref{taut:R o no R és vertadera} això és equivalent a veure que la relació
        \[
    ...
    \begin{proof}
        ...
        \]
        és vertadera.
        Ara bé, per la tautologia \myref{taut:R és equivalent a no no R} tenim que això és equivalent a veure que la relació
        \[
    ...
    \begin{proof}
        ...
        Per l'axioma \myref{axiom:relacions 2} la relació~\(S\lor(\lnot R)\) és vertadera i, per la definició de \myref{def:implicació} tenim que~\(R\implica S\) és vertadera.
        Ara bé, per la tautologia de \myref{taut:llei de les contrarecíproques} tenim que la relació~\((\lnot S)\implica(\lnot R)\) és vertadera, i pels axiomes \myref{axiom:relacions 4} i \myref{axiom:relacions 1} tenim que la relació
        \[
        ...
        Per la tautologia de \myref{taut:llei de les contrarecíproques} tenim que la relació~\((R\land S)\implica S\) és vertadera si i només si la relació
        \[
    ...
    \end{tautology}
    \begin{proof}
        Per la tautologia \myref{taut:R és equivalent a no no R} tenim que la relació~\(R\implica(\lnot(\lnot R))\) és vertadera, i per l'axioma \myref{axiom:relacions 4} això és que la relació
        \[
            (R\lor S)\sii(\lnot(\lnot R)\lor S)
        \]
        és vertadera.
        Ara bé, per la definició d'\myref{def:implicació} tenim que això és equivalent a la relació
        \[
    ...
    \begin{proof}
        ...
        \]
        és vertadera.
        Ara bé, com per hipòtesi~\(S\) és falsa per la tautologia \myref{taut:condicions per disjunció} tenim que la relació~\((\lor R)\land S\) és falsa.
        Per tant per la tautologia \myref{taut:condició equivalent a conjunció} tenim que la relació~\(R\land(\lnot S)\) és vertadera, i per la tautologia \myref{taut:condició equivalent a conjunció} tenim que~\(R\) és vertadera.
    \end{proof}
    \begin{tautology}
    ...
    \begin{proof}
        ...
        \]
        és vertadera.
        Com per hipòtesi la relació~\(R\) és vertadera, per la definició de \myref{def:negació} tenim que~\(\lnot R\) és falsa.
        I per la tautologia \myref{taut:condició equivalent a conjunció} tenim que la relació~\((\lnot R)\land S\) és falsa, i per la tautologia \myref{taut:condicions per disjunció} tenim que la relació~\(R\land(\lnot S)\) és vertadera.
...
\section{Conjunts}
    ...
    \begin{proof}
        ...
        Per tant, per l'\myref{axiom:axioma d'extensionalitat} tenim que~\(A=B\).
    ...
    \begin{proof}
        ...
        Aleshores, per l'\myref{axiom:axioma de separació} tenim que existeix un conjunt
        \[
        ...
        La unicitat la tenim per l'\myref{axiom:axioma d'extensionalitat}.
    \end{proof}
...
%    \end{axiom}
    ...
    \end{proposition}
    \begin{proof}
        Per la definició d'\myref{def:aplicació} hem de veure que~\(h\) està ben definida.
        ...
        Com que, per hipòtesi,~\(f\) és una aplicació tenim per la definició d'\myref{def:aplicació} que~\(f(a)=f(a')=b\), per a cert~\(b\in B\), i per tant, com que per hipòtesi~\(g\) és una aplicació, trobem~\(g(f(a))=g(b)=c\) i~\(g(f(a'))=g(b)=c\) per a cert~\(c\in C\), i per tant~\(h(a)=h(a')\), com volíem veure.

        També tenim que~\(f\subseteq A\times C\), ja que si~\(c=h(a)\) tenim~\(c=g(f(a))\), i per la definició d'\myref{def:aplicació} tenim que~\(a\in A\) i~\(c\in C\).
    ...
    \begin{proof}
        ...
        Aleshores tenim~\(g(f(a))=g(f(a'))\), i per la definició d'\myref{def:aplicació injectiva} com que, per hipòtesi~\(g\) i és injectiva tenim que~\(f(a)=f(a')\), i com que, per hipòtesi,~\(f\) és injectiva, tenim que~\(a=a'\), i de nou per la definició d'\myref{def:aplicació injectiva} tenim que~\(g\circ f\) és injectiva.
    \end{proof}
    \begin{theorem}
    ...
    \begin{proof}
        ...
        Aleshores per la definició d'\myref{def:aplicació exhaustiva} tenim que existeixen~\(a\in A\) i~\(b\in B\) tals que~\(b=f(a)\) i~\(c=g(b)\).
        Per tant per la definició d'\myref{def:aplicació exhaustiva} tenim que~\(g\circ f\) és una aplicació exhaustiva, ja que per a tot~\(c\in C\) existeix~\(a\in A\) tal que~\((g\circ f)(a)=c\).
    \end{proof}
    \begin{theorem}
    ...
    \end{theorem}
    \begin{proof}
        Per la definició d'\myref{def:aplicació bijectiva} hem de veure que~\(g\circ f\) és injectiva i exhaustiva.
        Ara bé, per hipòtesi tenim que~\(f\) i~\(g\) són bijectives, i de nou per la definició d'\myref{def:aplicació bijectiva} tenim que~\(f\) i~\(g\) són ambdues injectives i exhaustives.
        Per tant, pel Teorema \myref{thm:composició d'injectives injectiva} tenim que~\(g\circ f\) és injectiva, i pel Teorema \myref{thm:composició d'exhaustives exhaustiva} tenim que~\(g\circ f\) és exhaustiva, com volíem veure.
    \end{proof}
    ...
    \end{theorem}
    \begin{proof}
        Per la definició d'\myref{def:aplicació invertible} tenim que per a tot~\(a\in A\),~\(b\in B\)
        \[
    ...
    \begin{proof}
        ...
        Per la definició d'\myref{def:aplicació bijectiva} tenim que~\(f\) és injectiva i exhaustiva.
        Per tant per la definició d'\myref{def:aplicació injectiva} i la definició d'\myref{def:aplicació exhaustiva} tenim que per a tot~\(b\in B\) existeix un únic~\(a\in A\) tal que~\(b=f(a)\).
        ...
        \]
        i per la definició d'\myref{def:aplicació invertible} tenim que~\(f\) és invertible, com volíem veure.
        ...
        Ara bé, per la definició d'\myref{def:aplicació invertible} tenim que~\((f^{-1}\circ f)(a)=a\) i~\((f^{-1}\circ f)(a')=a'\) amb~\((f^{-1}\circ f)(a)=(f^{-1}\circ f)(a')\), i per tant~\(a=a'\) i per la definició d'\myref{def:aplicació injectiva} tenim que~\(f\) és injectiva.
...
\section{Relacions d'equivalència}
    ...
    \begin{proof}
        ...
        Aleshores per la definició de \myref{def:classe d'equivalència} tenim que~\(x\sim z\).
        Per hipòtesi tenim que~\(x\sim y\), i per tant, per la definició de \myref{def:relació d'equivalència} tenim que~\(y\sim z\), i per la definició de \myref{def:classe d'equivalència} trobem~\(z\in[y]\).
        ...
        Aleshores per la definició de \myref{def:classe d'equivalència} tenim que~\(y\sim z\).
        Per hipòtesi tenim que~\(x\sim y\), i per tant, per la definició de \myref{def:relació d'equivalència} tenim que~\(z\sim z\), i per la definició de \myref{def:classe d'equivalència} trobem~\(z\in[x]\).
        Per tant, per la definició de \myref{def:subconjunt} tenim que~\([y]\subseteq[z]\).
        Per tant, pel \myref{thm:doble inclusió} tenim que~\([x]=[y]\).

        Suposem ara que~\(x\nsim y\) i prenem un element~\(z\in[x]\cap[y]\).
        Aleshores, per la definició de \myref{def:classe d'equivalència} tenim que~\(z\sim x\) i~\(y\sim z\), i per la definició de \myref{def:relació d'equivalència} tenim que~\(x\sim y\).
...
\section{Els nombres naturals}
    ...
    \begin{proof}
        ...
        \end{align*}
        Ara bé.
        Per la definició de \myref{def:nombres naturals}, tenim que si~\(A\) és un conjunt tal que~\(1\in A\) i tal que~\(S(z)\in A\) per a tot~\(z\in A\), aleshores~\(\mathbb{N}\subseteq A\), i pel \myref{thm:doble inclusió} tenim que~\(A=\mathbb{N}\).
    \end{proof}
    \begin{proposition}
    ...
    \begin{proof}
        ...
        \end{align*}
        Ara bé.
        Per la definició de \myref{def:nombres naturals}, tenim que si~\(A\) és un conjunt tal que~\(1\in A\) i tal que~\(S(y)\in A\) per a tot~\(y\in A\), aleshores~\(\mathbb{N}\subseteq A\), i pel \myref{thm:doble inclusió} tenim que~\(A=\mathbb{N}\).
    \end{proof}
    \begin{proposition}
    ...
    \begin{proof}
        ...
        \end{align*}
        Ara bé.
        Per la definició de \myref{def:nombres naturals}, tenim que si~\(B\) és un conjunt tal que~\(1\in B\) i tal que~\(S(y)\in B\) per a tot~\(y\in B\), aleshores~\(\mathbb{N}\subseteq B\), i pel \myref{thm:doble inclusió} tenim que~\(\mathbb{N}=B\).
...
\section{Els nombres enters}
    ...
    \begin{proof}
        ...
        Per tant, per la definició de \myref{def:nombres enters} tenim~\((a,b)\sim(a-b,0)\), i per la definició de \myref{def:classe d'equivalència} trobem que~\(\overline{(a,b)}=\overline{(a-b,0)}\).
    ...
    \begin{proof}
        ...
        Per la definició de \myref{def:classe d'equivalència} això és
        \[
            (a,b)\sim(0,0),
        \]
    ...
    \begin{proof}
        ...
        Pel Teorema \myref{thm:caracterització del 0 dels enters} trobem que~\(c\neq d\).
    ...
    \begin{proof}
        ...
        Veiem ara el punt \eqref{enum:prop:oposats tenen els mateixos múltiples}.
    ...
    \begin{proof}
        ...
        \[
            0=d(q_{1}-q_{2})
        \]
        i com que, per hipòtesi,~\(d\neq0\), pel Teorema \myref{thm:Z és un DI} ha de ser~\(q_{1}-q_{2}=0\), i de nou per l'observació \myref{obs:elements que es tatxen son iguals} tenim~\(q_{1}=q_{2}\).
        Per tant la unicitat queda demostrada.

        Veiem ara que existeixen.
        Efectivament, si~\(D,d>0\) l'enunciat és cert pel lema \myref{lema:criteri de divisibilitat d'Euclides}.

        Si~\(D<0\) i~\(d>0\) definim~\(D'=-D\).
        Aleshores~\(D'>0\), i pel lema \myref{lema:criteri de divisibilitat d'Euclides} tenim que existeixen~\(q'\) i~\(r'\) enters tals que
        \[
            D'=dq'+r'
        \]
        amb~\(0\leq r'<d\).
    ...
    \begin{proof}
        ...
        Posem~\(d=as+bt\).
        Pel \myref{thm:criteri de divisibilitat d'Euclides} tenim que existeixen dos enters~\(q\) i~\(r\) amb~\(0\leq r<d\) tals que
        \[
            a=dq+r.
        \]
    ...
    \begin{proof}
        ...
        Per \myref{thm:identitat de Bézout} hem acabat.
        ...
        Tenim que si existeix un enter~\(c\) tal que~\(c\divides a\) i~\(c\divides b\), aleshores~\(c\divides 1\), i per la definició de \myref{def:màxim comú divisor} trobem que~\(\mcd(a,b)=1\).
    \end{proof}
    \begin{proposition}
    ...
    \begin{proof}
        Sigui~\(d=\mcd(a,b)\).
        Per la definició de \myref{def:màxim comú divisor} existeixen~\(a'\) i~\(b'\) tals que~\(a=da'\) i~\(b=db'\).
        ...
        Ara bé, per \myref{thm:identitat de Bézout} tenim que existeixen dos enters~\(\alpha\) i~\(\beta\) tals que~\(\alpha a+\beta b=d\).
        Per tant
        \begin{align*}
        ...
        Per tant, per la definició de \myref{def:mínim comú múltiple} tenim que~\(l=\mcm(a,b)\), i per tant
        \[
    ...
    \begin{proof}
        ...
        Per tant per la proposició \myref{prop:un enter que divideix al producte de dos, on un n'és coprimer, divideix a l'altre} tenim que~\(p\divides b\).
        El cas~\(p\ndivides b\) és anàleg.
    \end{proof}
    \begin{lemma}
    ...
    \end{proof}
    \begin{lemma}
        \label{lema:thm:Teorema Fonamental de l'Aritmètica 2}
    ...
    \begin{theorem}[Teorema Fonamental de l'Aritmètica]
        ...
        \labelname{Teorema Fonomental de l'Aritmètica}\label{thm:Teorema Fonamental de l'Aritmètica}
        Sigui~\(a>1\) un enter.
        Aleshores existeixen~\(p_{1},\dots,p_{n}\) primers amb~\(p_{1}\geq p_{2}\geq\dots\geq p_{n}\) únics tals que~\(a=p_{1}\cdots p_{n}\).
    \end{theorem}
    \begin{proof}
        És conseqüència del lema \myref{lema:thm:Teorema Fonamental de l'Aritmètica 1} i el lema \myref{lema:thm:Teorema Fonamental de l'Aritmètica 2}.
    \end{proof}
    ...
    \begin{proof}
        ...
        Ara bé, si~\(p\) no és primer pel lema \myref{lema:thm:Teorema Fonamental de l'Aritmètica 1} tenim que existeix un primer~\(p'\) tal que~\(p'\divides p\), però hem vist que~\(p_{1}\,dots,p_{m}\ndivides p\), per tant~\(p'\) és diferent de~\(p_{1},\dots,p_{m}\) i hem acabat.
    \end{proof}
...
%        \begin{proof}\end{proof}
    ...
    \begin{proof}
        ...
        Per tant per la proposició \myref{prop:condició equivalent a invertible en Z/(m)} tenim que~\(a\) és invertible.
    ...
    \begin{proof}
        ...
        Ara bé, per la definició de \myref{def:nombres modulars congruents} i la definició de \myref{def:màxim comú divisor} tenim que ha de ser
        \[
            x-x_{0}=\lambda M
        \]
    ...
    \begin{proof}
        ...
        Per la definició de \myref{def:mínim comú múltiple} i la definició de \myref{def:coprimers} tenim que \[M=\mcm(m_{1},\dots,m_{n})=\abs{\prod_{i=1}^{n}m_{i}}.\]
        ...
        \]
        té solució, ja que per la proposició \myref{prop:condició equivalent a invertible en Z/(m)} tenim que~\(M_{i}\) és invertible i per tant~\(x\equiv a_{i}M_{i}^{-1}\pmod{m_{i}}\).
        ...
        Per tant, pel lema \myref{lema:thm:Teorema xinès de les restes} tenim que
        \[
            x=x_{0}+\lambda M
        \]
...
\section{Les permutacions}
    ...
    \begin{proof}
        ...
        Aleshores per la definició de \myref{def:conjunt d'elements moguts per una permutació} trobem que~\(\{x\in X\mid\sigma(x)\neq x\}=\emptyset\), i per tant ha de ser~\(\sigma(x)=x\) per a tot~\(x\in X\), i per tant~\(\sigma=\Id_{X}\).

        Veiem ara l'implicació cap a l'esquerra (\(\implicatper\)).
        Prenem~\(\Id_{X}\).
        Aleshores ha de ser~\(\Mou(\Id_{X})=\emptyset\), ja que per la definició de \myref{def:conjunt d'elements moguts per una permutació} tenim que~\(\Mou(\Id_{X})=\{x\in X\mid\Id_{X}(x)\neq x\}\).
    \end{proof}
    \begin{proposition}
    ...
    \begin{proof}
        ...
        Això és, per la definició de \myref{def:conjunt d'elements moguts per una permutació}, que~\(a\in\{x\in X\mid\sigma\circ\tau(x)\neq x\}\).
        Volem veure que~\(a\in\Mou(\sigma)\cup\Mou(\tau)\), i per la definició d'\myref{def:unió de conjunts} hem de veure que~\(a\in\Mou(\sigma)\) ó~\(a\in\Mou(\tau)\).
    ...
    \end{proposition}
    \begin{proof}
        Per la proposició \myref{prop:Mou de la conjugació és unió dels Mous} tenim que~\(\Mou(\sigma\circ\tau)\subseteq\Mou(\sigma)\cup\Mou(\tau)\).
        Veiem doncs que~\(\Mou(\sigma\circ\tau)\supseteq\Mou(\sigma)\cup\Mou(\tau)\).

        Prenem un element~\(a\in\Mou(\sigma)\cup\Mou(\tau)\).
        Com que, per hipòtesi,~\(\sigma\) i~\(\tau\) són dues permutacions disjuntes, per la definició de \myref{def:permutacions disjuntes} tenim que~\(\Mou(\sigma)\cap\Mou(\tau)=\emptyset\) i per la definició d'\myref{def:intersecció de conjunts} tenim que o bé~\(a\in\Mou(\sigma)\) o bé~\(a\in\Mou(\tau)\).

        Suposem que~\(a\in\Mou(\sigma)\).
        Per la definició de \myref{def:conjunt d'elements moguts per una permutació} tenim que~\(\sigma(a)\neq a\) i~\(\tau(a)=a\), ja que~\(a\notin\Mou(\tau)\).
        Per tant~\(\sigma\circ\tau(a)=\sigma(a)\neq a\), i per tant~\(a\in\Mou(\sigma\circ\tau)\).

        Suposem ara que~\(a\in\Mou(\tau)\).
        Per la definició de \myref{def:conjunt d'elements moguts per una permutació} tenim que~\(\tau(a)\neq a\) i~\(\sigma(a)=a\), ja que~\(a\notin\Mou(\sigma)\).
        Per tant~\(\sigma\circ\tau(a)=\sigma(b)\) per a cert~\(b\neq a\),~\(b=\tau(a)\).
        Ara bé, com que per la definició de \myref{def:permutació}~\(\sigma\) és una aplicació bijectiva, i per la definició d'\myref{def:aplicació bijectiva} trobem que~\(\sigma\) és una aplicació injectiva, i per la definició d'\myref{def:aplicació injectiva} tenim que~\(\sigma(b)\neq a\), ja que~\(\sigma(a)=a\) i~\(b\neq a\).
    ...
    \end{lemma}
    \begin{proof} % REVISAR
        Per la definició de \myref{def:permutació} tenim que~\(\sigma\) és bijectiva, i per la definició de \myref{def:conjunt d'elements moguts per una permutació} trobem que~\(\sigma(x)=x\) si i només si~\(\sigma(\sigma(x))=\sigma(x)\).
    ...
    \end{theorem}
    \begin{proof}
        Per la definició de \myref{def:permutacions disjuntes} i la definició de \myref{def:conjunt d'elements moguts per una permutació} tenim que, per hipòtesi,~\(\Mou(\sigma)\cap\Mou(\tau)=\emptyset\).
        ...
        Per la definició de \myref{def:conjunt d'elements moguts per una permutació} tenim que~\(\tau(x)=x\) i per tant~\(\sigma(\tau(x))=\sigma(x)\).
        ...
        Per la definició de \myref{def:conjunt d'elements moguts per una permutació} tenim que~\(\sigma(x)=x\) i per tant~\(\tau(\sigma(x))=\tau(x)\).
    ...
    \end{proof}
    \begin{lemma}
        \label{lema:ordre d'un r-cicle}
        \label{lema:inversa d'un r-cicle}
    ...
    \end{theorem}
    \begin{proof}
        Pel lema \myref{lema:inversa d'un r-cicle} tenim que~\(\sigma^{r}=\Id_{X}\).
        Aleshores tenim~\(\sigma\circ\sigma^{r-1}=\Id_{X}\) i~\(\sigma^{r-1}\circ\sigma=\Id_{X}\).
        Per tant per la definició d'\myref{def:inversa d'una aplicació} trobem que~\(\sigma^{-1}=\sigma^{r-1}\).
    \end{proof}
...
\section{Els nombres racionals}
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            ...
            Per hipòtesi tenim que~\(ad=bc\), i per la proposició \myref{prop:Z és un anell commutatiu} tenim que~\(cb=da\) i trobem~\((c,d)\sim(a,b)\).
    ...
    \begin{proof}
        ...
        \[
            a\cdot1=b\cdot1.
        \]
        I per tant, per la proposició \myref{prop:Z és un anell} trobem que ha de ser~\(a=b\).
    \end{proof}
    \begin{proposition}
    ...
    \begin{proof}
        ...
        \[
            ac=0,
        \]
        i pel Teorema \myref{thm:Z és un DI} tenim que ha de ser~\(a=0\) ó~\(c=0\).
    \end{proof}
    \begin{theorem}
