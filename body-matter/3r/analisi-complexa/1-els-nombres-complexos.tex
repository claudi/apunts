\documentclass[../analisi-complexa.tex]{subfiles}
...
%        \[\field{C} = \{\alpha+\beta\iu\mid\alpha,\beta\in\field{R}\}.\]
    ...
    \begin{definition}[Conjugat d'un nombre complex]
        ...
        \label{def:conjugat-dun-nombre-complex}
    ...
    \end{definition}
    \begin{proposition}
        \label{prop:el-conjugat-del-conjugat-dun-nombre-complex-es-ell-mateix}
    ...
    \begin{proof}
        ...
        de \myref{def:conjugat-dun-nombre-complex} tenim que
        \begin{align*}
    ...
    \end{proof}
    \begin{proposition}
        \label{prop:el-conjugat-de-la-suma-es-la-suma-de-conjugats}
    ...
    \begin{proof}
        ...
        i la definició de \myref{def:conjugat-dun-nombre-complex} trobem
        que
        \begin{align*}
    ...
    \end{proof}
    \begin{proposition}
        \label{prop:el-conjugat-del-producte-es-el-producte-de-conjugats}
        Siguin~\(z\) i~\(w\) dos nombres complexos.
        Aleshores
        \[
    ...
    \begin{proof}
       ...
       ~\(a\),~\(b\),~\(c\),~\(d\in\field{R}\) tals que
        ...
        de \myref{def:conjugat-dun-nombre-complex} trobem que
        \begin{align*}
    ...
    \end{proof}
    \begin{proposition}
        \label{prop:el-producte-dun-nombre-complex-pel-seu-conjugat-es-la-suma-dels-quadrats-de-la-seva-part-real-i-imaginaria}
        Sigui~\(z = a+b\iu\) un nombre complex.
        Aleshores
        \[
    ...
    \begin{proof}
        ...
        definició de \myref{def:conjugat-dun-nombre-complex} trobem que
        \begin{align*}
    ...
    \end{proof}
    \begin{proposition}
        \label{prop:un-nombre-complex-es-igual-al-seu-conjugat-si-i-nomes-si-es-un-real}
        Sigui~\(z\) un nombre complex.
    ...
    \begin{proof}
        ...
        \end{align*}
        i per la definició de \myref{def:linvers-dun-element-dun-anell}
        hem acabat.
    \end{proof}
    ...
    \begin{proof}
        ...
        \]
        i per la definició
        de \myref{def:part-real-i-part-imaginaria-dun-nombre-complex} hem
        acabat.
    \end{proof}
    ...
    \begin{proof}
        ...
        proposició \myref{prop:el-producte-dun-nombre-complex-pel-seu-conjugat-es-la-suma-dels-quadrats-de-la-seva-part-real-i-imaginaria}
        trobem que
        \begin{align*}
            z\conjugat{z} &= a^{2}+b^{2} \\
    ...
    \end{proposition}
    \begin{proof}
        Per la definició de \myref{def:modul-dun-nombre-complex} tenim que
        \begin{align*}
