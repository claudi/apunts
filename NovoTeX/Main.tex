...
\newcommand{\norma}[1]{\left\lvert#1\right\rvert} % Norma complexa (una barra vertical)
\newcommand{\norm}[1]{\left\lVert#1\right\rVert}  % Norma general (dues barres verticals)
...
%\makeindex[not]
 ...
 %%%%% BIBLIOGRAFIA %%%%%
\addbibresource{BackMatter/referencies.bib}
...
\title{\href{https://claudilleyda.github.io}{Apunts de matemàtiques}}
...
\newcommand{\link}{https://claudilleyda.github.io}
\hypersetup{
	colorlinks=true,
...
\setlength{\headheight}{12.1638pt} %TODO Investigar. Crec que només és per la taula de continguts
...
\newcommand{\primer}{
	...
	\subfile{BodyMatter/1r/Intro.tex}
...
%	\subfile{BodyMatter/2n/Apendix2n.tex} % Teoria de la mesura
}
\newcommand{\tercer}{
	\book{Tercer curs}
...
%	\subfile{BodyMatter/3r/Apendix3x.tex} % Formes diferencials (?)
}
...
\newcommand{\indexos}{{
	...
	\printindex
%	\cleartoevenpage
%	\renewcommand{\indexname}{Índex de notació} % Gloassari de notació? Pàgs. al grossari
%	\printindex[not]
}}
