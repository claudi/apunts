...
\newcommand{\titleTMB}{
    \begingroup % Three Men in a Boat
        ...
        \vfill
        {\centering\includegraphics{front-matter/portada/portada.pdf}}
        \vfill
...
\newcommand{\agraiments}{
    \subfile{front-matter/agraiments.tex}
}
\newcommand{\lletresgregues}{
    \subfile{front-matter/lletres-gregues.tex}
}
...
\newcommand{\primer}{
    \book{Primer curs}
    \subfile{body-matter/1r/temp-intro.tex}
    \subfile{body-matter/1r/fonaments-de-les-matematiques.tex}
    \subfile{body-matter/1r/algebra-lineal.tex}
    \subfile{body-matter/1r/funcions-de-variable-real.tex}
    %\subfile{body-matter/1r/geometria-projectiva.tex}
%    \subfile{body-matter/1r/Apendix1r.tex} % Geometria projectiva
}
\newcommand{\segon}{
    \book{Segon curs}
    \subfile{body-matter/2n/calcul-en-diverses-variables.tex}
    \subfile{body-matter/2n/analisi-matematica.tex}
    \subfile{body-matter/2n/geometria-lineal.tex}
    \subfile{body-matter/2n/matematica-discreta.tex}
    \subfile{body-matter/2n/estructures-algebraiques.tex}
    \subfile{body-matter/2n/metodes-numerics.tex}
    %\subfile{body-matter/2n/teoria-de-la-mesura.tex}
%    \subfile{body-matter/2n/Apendix2n.tex} % Teoria de la mesura (Lebesge o per probabilitat?)
}
\newcommand{\tercer}{
    \book{Tercer curs}
    \subfile{body-matter/3r/topologia.tex}
    \subfile{body-matter/3r/probabilitat.tex}
    \subfile{body-matter/3r/equacions-diferencials-I.tex}
    \subfile{body-matter/3r/teoria-de-Galois.tex}
    \subfile{body-matter/3r/analisi-complexa.tex}
    \subfile{body-matter/3r/estadistica.tex}
    \subfile{body-matter/3r/geometria-diferencial.tex}
    \subfile{body-matter/3r/equacions-diferencials-II.tex}
    %\subfile{body-matter/3r/calcul-tensorial.tex}
%    \subfile{body-matter/3r/Apendix3r.tex} % Formes diferencials (?) 
