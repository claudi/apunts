...
\chapter{Equacions diferencials de primer ordre en una variable}
	\section{Espai de funcions contínues i acotades sobre un espai topològic}
	...
	\begin{notation}[Espai de funcions contínues i acotades]
		...
		Sigui \(X\) amb la topologia \(\tau\) un espai topològic. Aleshores denotem
		\[\mathcal{C}_{b}(X,T)=\{f(x)\mid\text{tal que }f(x)\text{ és una funció contínua i acotada de }X\text{ a }T\}.\]
	\end{notation}
	\begin{definition}[Distància entre funcions]
		\labelname{distància entre funcions acotades}\label{def:distància entre funcions acotades}
		Siguin \(X\) amb la topologia \(\tau\) un espai topològic i \(f(x)\) una funció de \(\mathcal{C}_{g}(X)\). Aleshores definim
	...
	\end{proposition}
	\begin{definition}[Distància entre funcions]
		\labelname{distància entre funcions}\label{def:distància entre funcions}
		Siguin \(X\) amb la topologia \(\tau\) un espai topològic i \(f\) i \(g\) dues funcions de \(\mathcal{C}_{b}(X)\). Aleshores definim
		\[\distancia(f,g)=\norm{f(x)-g(x)}\]
		com la distància entre \(f\) i \(g\) en \(\mathcal{C}_{b}(X)\).
	\end{definition}
	\begin{proposition}
		...
		Sigui \(X\) amb la topologia \(\tau\) un espai topològic. Aleshores \(\mathcal{C}_{b}(X)\) 
	\end{proposition}
	...
	\begin{theorem}
		...
		Siguin \(X\) amb la topologia \(\tau\) un espai topològic. Aleshores \(\mathcal{C}_{b}(X)\) és complet.
		\begin{proof}
			Sigui \((f_{n})_{n\in\mathbb{N}}\) una successió de Cauchy de \(\mathcal{C}_{b}(X)\). Per la definició de \myref{def:successió de Cauchy amb normes} tenim que per a tots naturals \(n\) i \(m\) existeix un real \(\varepsilon>0\) tal que
			\[\norm{f_{n}-f_{m}}<\varepsilon.\]
			Per la definició de \myref{def:distància entre funcions} trobem que
			...
			i per la definició de \myref{def:convergència uniforme} tenim que \((f_{n})_{n\in\mathbb{N}}\) convergeix uniformement a \(f(x)\), i per la definició de \myref{def:espai mètric complet} tenim que \(\mathcal{C}_{b}(X)\) és complet.
		\end{proof}
	\end{theorem}
