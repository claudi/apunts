...
%	\end{proposition}
	...
	\begin{proposition}
		...
		\begin{proof}
			Siguin \((I_{i},u_{i})_{i\in J}\) una família de solucions del problema de Cauchy amb \((I_{i},u_{i})\leq(I_{j},u_{j})\) si \(i\leq j\). Aleshores, per la definició de \myref{def:cadena}, trobem que la família \((I_{i},u_{i})_{i\in J}\) és una cadena.
