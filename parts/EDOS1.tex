...
%	\end{proposition}
	...
	Definicions d'equació diferencial, problema de Cauchy, exemples...
...
%	\end{proposition}
	\begin{proposition}
		...
		\begin{equation}
			...
			\end{cases}
		\end{equation}
		té una única solució. Aleshores per a cada \((t_{0},x_{0})\) de \(\Omega\) el problema de Cauchy \eqref{prop:la solució improrrogable és única:eq1} té una única solució improrrogable.
		\begin{proof}
