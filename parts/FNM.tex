...
%	\end{axiom}
	...
	\begin{theorem}
		...
		\begin{proof}
			...
			Veiem ara que la condició és necessària (\(\Leftarrow\)). Suposem doncs que existeixen dos enters \(\alpha\) i \(\beta\) tals que \(\alpha a+\beta b=1\). Tenim que si existeix un enter \(c\) tal que \(c\divides a\) i \(c\divides b\), aleshores \(c\divides 1\), i per la definició de \myref{def:màxim comú divisor} trobem que \(\mcd(a,b)=1\).
		\end{proof}
	\end{theorem}
	\begin{proposition}
