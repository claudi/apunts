...
\begin{document}
	...
	\begin{theorem}
		...
		\end{enumerate}
		\begin{proof}
			Comencem demostrant \eqref{enum:definicions alternatives de grup 1}\(\implica\)\eqref{enum:definicions alternatives de grup 2}. Suposem que \(G\) és un grup amb l'operació. Veiem que \(G\) no és buit per la definició de \myref{def:grup}, i la segona part és el lemma \myref{lemma:solucions úniques en grups a equacions}.
...
%	\end{proposition}
	...
	\begin{proposition}
		...
		\begin{proof}
			...
			Comencem veient la implicació cap a la dreta (\(\implica\)). Suposem doncs que \(R/M\) és un cos i prenem un ideal \(I/M\) %REF lemma teorema d'isomorfia anells per donar-li sentit
