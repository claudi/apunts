...
\section{Dominis}
	...
	\begin{theorem}
		...
		\begin{proof}
			...
			per a tot \(k\in\mathbb{N}\), i pel \myref{thm:doble inclusió} trobem que \(I_{n}=I_{n+k}\) per a tot \(k\in\mathbb{N}\), i per la definició de \myref{def:anell Noetherià} trobem que \(D\) és un anell Noetherià.
		\end{proof}
	\end{theorem}
	\begin{theorem}
