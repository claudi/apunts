...
\begin{document}
	...
	\begin{definition}[Mínim subgrup generat per un conjunt] %vspace
		...
		Siguin \(G\) un grup amb l'operació \(\ast\), \(S\) un subconjunt de \(G\), \(\{H_{i}\}_{i\in I}\) una família de subgrups de \(G\) tals que \(S\subseteq H_{i}\) per a tot \(i\in I\) i tal que
	...
	\begin{proposition}
		...
		Siguin \(G\) un grup amb l'operació \(\ast\) i \(g\) un element de \(G\). Aleshores
