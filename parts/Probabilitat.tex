...
\subsection{Variables aleatòries absolutament contínues}
	\begin{definition}[Variable aleatòria absolutament contínua]
		...
		\end{enumerate}
		Aleshores direm que~\(X\) és una variable aleatòria absolutament contínua. També direm que~\(f\) és la funció distribució de~\(X\) i que la funció
