...
\subsection{Àlgebres i \ensuremath{\sigma}-àlgebres}
	...
	\begin{proposition}
		...
		\begin{proof}
			Tenim que
			\[A^{\complement}=\Big(\bigcap_{n\in\NN}A_{n}\Big)^{\complement}=\Big(\bigcup_{n\in\NN}A_{n}^{\complement}\Big).\]
...
\subsection{L'àlgebra de Borel}
	...
	\begin{definition}[Probabilitat]
		...
		\begin{enumerate}
			...
			\begin{equation}
				\Probabilitat\Big(\bigcup_{n\in\NN}A_{n}\Big)=\sum_{n\in\NN}\Probabilitat(A_{n}).
	...
	\begin{notation}[Unió disjunta]
		...
		\[\bigcup_{n\in\NN}A_{n}=\biguplus_{n\in\NN}A_{n}\]
	...
	\begin{proposition}
		...
		\begin{proof}
			...
			\[\emptyset=\biguplus_{n\in\NN}\emptyset.\]
			Aleshores per la definició de~\myref{def:probabilitat} tenim que
			\[\Probabilitat(\emptyset)=\sum_{n\in\NN}\Probabilitat(\emptyset),\]
	...
	\begin{theorem}[Definició de Laplace]
		...
		\end{proof}
	\end{theorem}
%\chapter{Variables i vectors aleatòris}
