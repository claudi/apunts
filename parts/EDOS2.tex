...
\section{Equacions en derivades parcials de primer ordre}
	...
	\subsection{Equacions lineals i quasilineals de primer odre}
...
\section{Equacions en derivades parcials de primer ordre}
	...
	\end{definition}
	\subsection{Equacions quasilineals de primer ordre}
	\begin{definition}[Equació quasilineal]
		\labelname{equació diferencial quasilineal}\label{def:equació diferencial quasi lineal}
		...
		és una equació diferencial quasilineal de primer ordre.
	\end{definition}
	\begin{example}
		Exemples d'equacions quasilineals són, amb \(K>0\), l'equació de la calor
		...
		mentre que exemples d'equacions en derivades parcials que no siguin quasilineals són l'equació no lineal de la calor
