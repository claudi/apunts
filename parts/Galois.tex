...
%	\end{proposition}
	...
	\begin{lemma}
		...
		\begin{proof} %FER %Revisar
			...
			\[\KK(\alpha)=\KK[\alpha].\]
			Per tant~\(\KK[\alpha]\) és un cos, i com que, per l'observació~\myref{obs:extensió algebraica}, tenim que~\(\alpha\in\KK[\alpha]\), i per la definició de~\myref{def:cos per anells} tenim que~\(-1/\alpha\in\KK[\alpha]\). Aleshores, per la definició d'\myref{def:extensió algebraica} trobem que existeix un polinomi~\(a_{0}+a_{1}x+\dots+a_{k}x^{k}\in\KK[x]\), amb~\(a_{k}\neq0\), tal que
