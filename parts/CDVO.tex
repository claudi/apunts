...
\begin{document}
	...
	\begin{proposition}
		...
		\end{align*}
		Aleshores
		\[f\text{ és diferenciable en }a\sii f_{i}\text{ és diferenciable en a }\forall i\in \{1,\dots,m\}.\]
		\begin{proof}
	...
	\begin{proposition}\label{prop:homeomorfisme a difeomorfisme}
		...
		\begin{proof}
			Demostrem la implicació cap a la dreta \((\implica)\). En un entorn de \(a\), \(f\) es comporta com un difeomorfisme per la definició de \myref{def:difeomorfisme}. Per tant, amb el coro{\lgem}ari \myref{corollary:difeomorfime determinant} queda demostrat.
