...
\section{Funcions diferenciables}
	...
	\begin{proposition}\label{prop:difeomorfisme diferenciable invertible}
		...
		\[d(\Phi^{-1})=(d\Phi)^{-1}.\] https://math.stackexchange.com/questions/207392/invertible-derivative
	\end{proposition}
	\begin{proof}
...
\section{Teoremes de la funció implícita i inversa}
	...
	\begin{proof}
		%TODO
	\end{proof}
%	\begin{proof}\textbf{Ignorar aquesta demostració per ara}
