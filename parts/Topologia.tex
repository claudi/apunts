...
%	\end{proposition}
	...
	\begin{proposition}
		...
		\end{proof}
	\end{proposition}
	\begin{notation}[Topologia induïda per un subconjunt]
		\labelname{topologia induïda per un subconjunt}\label{notation:topologia induida per un subconjunt}
	...
	\end{definition}
	propietats i exemples. exemples i propietats
