...
%	\end{definition}
	...
	\begin{proposition}
		...
		\begin{proof}
			Per la definició d'\myref{def:espai Hausdorff} trobem que per a tot punt \(y\) diferent de \(x\) existeixen dos oberts disjunts \(\obert{U}_{y}\) i \(\obert{V}_{y}\) tals que \(x\) pertany a \(\obert{U}_{y}\) i \(y\) pertany a \(\obert{V}_{y}\). %TODO
		\end{proof}
	\end{proposition}
	\begin{proposition}
		...
		\end{proof}
	\end{proposition}
	\subsection{Axiomes de separació}
...
%	\end{proposition}
	\begin{definition}[Espai regular]
		...
		Sigui \(X\) un espai de Kolmogorov tal que donats un tancat \(\tancat{C}\) i un punt \(x\) que no pertany a \(\tancat{C}\) existeixen dos oberts disjunts \(\obert{U}\) i \(\obert{V}\) tals que \(x\) pertany a \(\obert{U}\) i \(\obert{V}\) és un subconjunt de \(\tancat{C}\). Aleshores direm que \(X\) és un espai regular.
	\end{definition}
	\begin{definition}[Espai normal]
		\labelname{espai normal}\label{def:espai normal}
		Sigui \(X\) un espai de Kolmogorov tal que donats dos tancats disjunts \(\tancat{C}\) i \(\tancat{K}\) existeixen dos oberts disjunts \(\obert{U}\) i \(\obert{V}\) tals que \(\obert{U}\) és un subconjunt de \(\tancat{C}\) i \(\obert{V}\) és un subconjunt de \(\tancat{K}\). Aleshores direm que \(X\) és un espai normal.
	\end{definition}
	...
	\begin{proposition}
		...
		\begin{proof} % REVISAR i arreglar wording
			Si \(A=X\) o \(A=\emptyset\) aleshores pel Teorema \myref{thm:equivalència obert tancat definició de topologia} trobem que \(A\) és tancat i hem acabat.
	...
	\begin{theorem}
		...
		\begin{proof}
			Comencem veient que la condició és suficient (\(\implica\)). Suposem doncs que \(X\times Y\) és Hausdorff. Prenem un element \(y\) de \(Y\).
		\end{proof}
	\end{theorem}
