...
%	\end{proposition}
	...
	\begin{proposition}
		...
		\begin{proof}
			Prenem un element \(x\) de \(\interior(A)\). Per la definició d'\myref{def:interior} tenim que existeix un obert \(\obert{U}_{x}\) tal que \(x\in\obert{U}_{x}\) i \(\obert{U}_{x}\subseteq A\). Aleshores tenim
			\begin{align*}
