...
%	\subsection{Teorema de classificació de les superfícies compactes}
	...
	\printbibliography
	La majoria del contingut està escrit seguint \cite{ACTEAguade}, que també s'utilitza per les classes de teoria de l'assignatura. He extret la demostració d'un Teoremaa de \cite{SchultzFreeActionsOnFiniteGroupsOnHausdorffSpaces}.
