...
%	\end{proposition}
	...
	\begin{proposition}
		...
		\begin{proof}
			Sigui \(\tancat{C}\) un tancat tal que \(A\) sigui un subconjunt de \(\tancat{C}\) i \(x\) un punt de \(\clausura(A)\setminus\tancat{C}\). Per tant trobem que \(x\) és un element de \(X\setminus\tancat{C}\), i com que, per hipòtesi, \(\tancat{C}\) és un tancat, per la definició de \myref{def:tancat} trobem que \(X\setminus\obert{C}\) és un obert, i per tant \((X\setminus\tancat{C})\cap A\neq\emptyset\)
		\end{proof}
	\end{proposition}
