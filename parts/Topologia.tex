...
\chapter{Altres topologies}
	...
	\end{theorem}
	\begin{proposition}
		\label{prop:si dues parelles d'espais topològics són isomorfs els seus productes cartesians també ho són}
	...
	\begin{example}
		...
		\begin{solution}
			Per l'exercici \myref{ex:un recobriment obert de R} tenim que \(\{(-i,i)\}_{i\in\mathbb{N}}\) és un recobriment obert de \(\mathbb{R}\).
	...
	\begin{example}
		...
		\begin{solution}
			Per l'exercici \myref{ex:R és homeomorf a l'interval (0,1)} tenim que l'interval \((0,1)\) és homeomorf a \(\mathbb{R}\), per l'exercici \myref{ex:R no és compacte} trobem que \(\mathbb{R}\) no és compacte i per la proposició \myref{prop:la compacitat és una propietat topològica} tenim que \((0,1)\) no és compacte.
		\end{solution}
	\end{example}
	\begin{proposition}
	...
	\begin{proposition}
		...
		\begin{proof}
			...
			Per l'exercici \myref{ex:topologia discreta} tenim que tot subconjunt de \(X\) és un obert, i com que
			\[X=\bigcup_{x\in X}\{x\}\]
	...
	\begin{theorem}
		...
		\begin{proof}
			...
			Ara bé, per hipòtesi tenim que \(X\) és un compacte, i per la definició d'\myref{def:espai topològic compacte} tenim que existeix un subrecobriment finit de~\(\{\obert{U}_{i}\}_{i\in I}\cup(X\setminus\tancat{C})\).
			%FER
		\end{proof}
	\end{theorem}
	\begin{comment}
