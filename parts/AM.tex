...
%		Buscar la que va sortir a un dels exàmens. El de la recu?
	...
	\end{definition}
	\begin{lemma}
		\label{lema:Teorema d'aproximació polinòmica d'Stone-Weierstrass}
		...
		\end{proof}
	\end{lemma}
	\begin{theorem}[Teorema d'aproximació polinòmica d'Stone-Weierstrass]
		\labelname{Teorema d'aproximació polinòmica d'Stone-Weierstrass}\label{thm:Teorema d'aproximació polinòmica d'Stone-Weierstrass}
