...
%	\subsection{Els nombres complexos}
	...
	\begin{example}
		...
		Volem trobar la sèrie de Fourier de la extensió periòdica de la funció
		\[f(x)=\begin{cases}
	...
	\begin{proposition}
		...
		on
		\[A_{n}=\int_{0}^{1}f(x)\cos(2\uppi nx).\] % A_{0}=\int_{0}^{1}f(x)\diff x
		\begin{proof}
			%TODO
		\end{proof}
	\end{proposition}
	\begin{proposition}
		...
		on
		\[B_{n}=\int_{0}^{1}f(x)\sin(2\uppi nx).\]
		\begin{proof}
			%TODO
		\end{proof}
	\end{proposition}
	\begin{theorem}
		...
		on
		\[A_{n}=\int_{0}^{1}f(x)\cos(2\uppi nx)\quad\text{i}\quad B_{n}=\int_{0}^{1}f(x)\sin(2\uppi nx).\]
		\begin{proof}
			%TODO
		\end{proof}
	\end{theorem}
