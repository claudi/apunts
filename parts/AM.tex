...
%			\[\alpha\log\left(\frac{x}{x+1}\right)=\log\left(x^{\alpha}\right)-\alpha\log(x+1)\]
	...
	\begin{example}[Sèrie harmònica alternada]
		...
		\begin{solution}
			...
			és divergent, i pel coro{\lgem}ari \myref{cor:terme general tendeix a zero en una sèrie convergent} trobem que la sèrie és divergent.
	...
	\begin{proposition}
		...
		\begin{proof}
			...
			\[\sum_{n=0}^{\infty}\abs{a_{n}}\]
			és convergent, i pel coro{\lgem}ari \myref{cor:la reordenada d'una sèrie de termes positius convergent conserva la sèrie} trobem que
	...
	\begin{lemma}
		...
		Sigui \(\sum_{n=0}^{\infty}a_{n}\) una sèrie. Aleshores tenim que \(\sum_{n=0}^{\infty}a_{n}\) és absolutament convergent si i només si les sèries \(\sum_{n=0}^{\infty}a^{+}_{n}\) i \(\sum_{n=0}^{\infty}a^{-}_{n}\) són convergents.
		\begin{proof}
			Comencem veient que la condició és suficient (\(\implica\)). Suposem doncs que la sèrie \(\sum_{n=0}^{\infty}a_{n}\) és absolutament convergent. Per la proposició \myref{prop:una sèrie absolutament convergent és convergent} trobem que la sèrie \(\sum_{n=0}^{\infty}a_{n}\) és convergent. 
		\end{proof}
	\end{lemma}
	\begin{theorem}[Teorema de la reordenació de sèries de Riemann]
		...
		\begin{proof}
			Prenem un \(\alpha\) real. Tenim per hipòtesi i la definició de \ref{def:convergència absoluta d'una sèrie} que la sèrie \(\sum_{n=0}^{\infty}a^{+}_{n}-a^{-}_{n}\) és convergent i la sèrie \(\sum_{n=0}^{\infty}a^{+}_{n}+a^{-}_{n}\) és divergent. Per tant ha de ser que les sèries \(\sum_{n=0}^{\infty}a^{+}_{n}\) i \(\sum_{n=0}^{\infty}a^{-}_{n}\) són divergents.
			
			Definim
			\[S_{N}=\sum_{n=0}^{N}a^{+}_{n}\quad\text{i}\quad T_{N}=\sum_{n=0}^{N}a^{-}_{n}.\]
			
			Com que la sèrie \(\sum_{n=0}^{\infty}a^{+}_{n}\) és divergent tenim que existeix un natural mínim \(n_{1}\) tal que
			\[S_{n_{1}}\geq\alpha,\]
			i tenim que
			\[S_{n_{1}}+a^{+}_{n_{1}}\geq\alpha+a^{+}_{n_{1}}.\]
