...
%		\ref{def:diferencial}
	...
	\begin{definition}[Curvatura]
		...
		Sigui \(\alpha\) una corba sobre \(I\) i dues vegades diferenciable. Aleshores direm que l'aplicació
		\begin{align*}
...
%			\[\beta'(t)=\]
	...
	\begin{proposition}[Fórmules de Frenet]
		...
		Sigui \(\alpha\) una corba parametritzada per l'arc amb curvatura no nu{\lgem}a. Aleshores
		\[\begin{bmatrix}
			\tangent'_{\alpha}(t) \\
			\normal'_{\alpha}(t) \\
			\binormal'_{\alpha}(t)
