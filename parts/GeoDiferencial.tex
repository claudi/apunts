...
%		\ref{def:diferencial}
	...
	\begin{proposition}
		...
		\end{proof}
	\end{proposition}
	\subsection{Producte escalar i producte vectorial} % de corbes parametritzades per l'arc
	\begin{proposition}
	...
	\begin{example}
		...
		\begin{solution}
			...
			i per la definició de \myref{def:curvatura} trobem que \(\curvatura(s)=\frac{1}{R}\).
		\end{solution}
	\end{example}
	\begin{proposition}
