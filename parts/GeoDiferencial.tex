...
%			\[\pi_{1}\circ g\circ\Psi_{1}\]
	...
	\section{Espai tangent a una superfície}
	...
	\begin{proposition}
		...
		\[\PrimeraFormaFonamental_{p}(\vec{v},\vec{w})=\vec{v}^{t}\begin{bmatrix}
			E & F \\ F & G
		\end{bmatrix}\vec{w}.\]
	\end{proposition}
\end{document}
