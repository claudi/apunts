...
\newcommand*{\titleTMB}{\begingroup% Three Men in a Boat
	...
	\begin{tikzpicture}
		...
		\node[black,rotate=180-336.5-90] at (180-336.5:3cm+0.6em) {\includegraphics[height=1em]{imatges/UABlogo.png}};
		\node[black,rotate=336.5-90] at (336.5:3cm+0.6em) {\includegraphics[height=1em]{imatges/UABlogo.png}};
		\path [postaction={decorate,decoration={text along path, text align=center,
		text={|\color{black}|Grau en Matem{à}tiques }}}] (210:3cm+1em) arc (210:330:3cm+1em);
	\end{tikzpicture}}
	\vfill
...
%\DeclareRobustCommand{\myref}[1]{\mynameref{#1}{\csname r@#1\endcsname}}
