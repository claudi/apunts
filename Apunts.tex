...
\newlength{\ample}
\setlength{\ample}{1.5pt}
\newlength{\ampledashed}
\setlength{\ampledashed}{1.2pt}
...
\newcommand*{\titleTMB}{\begingroup% Three Men in a Boat
	...
	{\centering\begin{tikzpicture}
		...
		\tkzDrawPoints[shape=circle,color=black,fill=black](E,M)
		
		\tkzDrawSegment[line width=\ample](P9,F)
		\tkzDrawSegment[line width=\ample](P7,F)
		\tkzDrawSegment[line width=\ample](P4,F)
		\tkzDrawSegment[line width=\ample](P1,F)
		
		\tkzDrawSegment[line width=\ample](F,A)
		\tkzDrawSegment[line width=\ample](A2,A)
		\tkzDrawSegment[line width=\ample](D2,D)
		
		\tkzDrawSegment[line width=\ample](P_{3},P_{14})
		\tkzDrawSegment[line width=\ample](P_{14},P_{3})
		\tkzDrawSegment[line width=\ample](P_{3},A2)
		
		\tkzDrawCircle[line width=\ample](M,H)
		\tkzDrawCircle[line width=\ample](G',J)
		
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{3},P_{0})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{6},P_{3})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{9},P_{6})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{12},P_{9})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{15},P_{12})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{1},P_{15})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{4},P_{1})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{7},P_{4})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{10},P_{7})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{13},P_{10})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{16},P_{13})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{2},P_{16})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{5},P_{2})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{8},P_{5})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{11},P_{8})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{14},P_{11})
		\tkzDrawSegment[line width=\ampledashed, dashed](P_{0},P_{14})
