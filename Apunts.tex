...
\newcommand*{\titleTMB}{\begingroup% Three Men in a Boat
	...
	\begin{tikzpicture}
		...
		text={|\sffamily\color{black}|Universitat Aut{ò}noma de Barcelona}}}] (-30:3cm+0.3em) arc (-30:210:3cm+0.3em);
		\node[black,rotate=180-338.5-90] at (180-338.5:3cm+0.6em)
		{\includegraphics[width=0.667em]{imatges/UABLogo.pdf}};
		\node[black,rotate=338.5-90] at (338.5:3cm+0.6em)%
		{\includegraphics[width=0.667em]{imatges/UABLogo.pdf}};
		\path [postaction={decorate,decoration={text along path, text align=center,
		text={|\color{black}|Grau en Matem{à}tiques }}}] (210:3cm+0.9em) arc (210:330:3cm+0.9em);
	\end{tikzpicture}}
	\vfill
...
\makechapterstyle{cveelo}{%
  ...
  \renewcommand*{\chapnamefont}{\normalfont\LARGE\flushright\color{black}}
  \renewcommand*{\chapnumfont}{\normalfont\HUGE}
  \renewcommand*{\chaptitlefont}{\normalfont\Huge\bfseries\flushright\color{black}}
...
\begin{document}
	{\hypersetup{urlcolor=black,linkcolor=black}
		...
		\end{titlingpage*}
	\tableofcontents}
	Moltes gràcies a qui m'ha ajudat.
