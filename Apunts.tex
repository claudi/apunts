...
%\usepackage{lmodern}
%\usepackage{fixcmex} % Pensar-hi
%https://tex.stackexchange.com/questions/375823/ugly-alignment-size-of-square-root-symbol-with-latin-modern-at-12pt?noredirect=1&lq=1
%\usepackage[adobe-utopia]{mathdesign}
\usepackage[mathcal]{euscript}	% hmm
%\usepackage{mathpazo}
%\usepackage[euler-digits]{eulervm}
%\usepackage[framemethod=TikZ]{mdframed}
%	\usetikzlibrary{euclide}
%\usepackage[scaled]{beraserif}
%\usepackage[urw-garamond]{mathdesign} % No va?
...
\addbibresource{parts/referencies.bib}
...
\title{%
	\href{https://claudi.github.io}{Apunts de matemàtiques}}
...
\DeclareMathOperator{\Varianca}{Var}
...
\newcommand{\grauExtensio}[2]{[#1\colon #2]} % Dunno why I had :

\newcommand{\mitjana}[1]{\bar{#1}}

\newcommand{\diff}{\mathop{}\!\mathrm{d}}
\newcommand{\e}{\mathrm{e}}
\newcommand{\iu}{\mathrm{i}}
%\newcommand{\uppi}{\pi} % REVISIT
\newcommand{\GrupOrtogonal}{\mathrm{O}}
\newcommand{\GrupEspecialOrtogonal}{\mathrm{SO}}
\newcommand{\matrius}{M}
...
\makeatletter
	...
	\def\E{\@ifnextchar[{\@Ewith}{\@Ewithout}}
	\def\@Ewith[#1]#2{\Esperanca\csname #1l\endcsname[#2 \csname #1r\endcsname]}
	\def\@Ewithout#1{\Esperanca[#1]}

	\def\Var{\@ifnextchar[{\@Varwith}{\@Varwithout}}
	\def\@Varwith[#1]#2{\Varianca \csname #1l\endcsname(#2\csname #1r\endcsname)}
	\def\@Varwithout#1{\Varianca(#1)}
\makeatother
...
% REVISAR SI NO ES MENJA ELS ESPAIAS ABANS DE PUNTS I TAL
...
\newcommand{\tauladetauladecontinguts}{
	\begingroup
%		\setsecnumdepth{book}
...
\makeatletter
\def\myref{\@ifnextchar[{\@myref@opt}{\@myref@}}
	\def\@myref@opt[#1]#2{\hyperref[#2]{#1~(\ref*{#2})}}
	\def\@myref@#1{\mynameref{#1}{\csname r@#1\endcsname}}
\makeatother
%\def\myref#1{\ref{#1}}
\renewcommand{\myref}[1]{\mynameref{#1}{\csname r@#1\endcsname}}
%%\newcommand{\myref}[1]{\hyperref[#1]{\nameref{#1} \eqref{#1}}}

%\makeatletter
%\DeclareRobustCommand{\myref}[1]{%
%	\@ifundefined{nameref{#1}}{%
%		\ref{#1}%
%	}{%
%		\nameref{#1}~\eqref{#1}%
%	}%
...
\makeatletter
\DeclareRobustCommand\mynameref[2]{%
	\begingroup
		\edef\@mytxt{#2}%
...
%	\book{Tercer curs}
	...
	\subfile{parts/Probabilitat.tex}
	\subfile{parts/EDOS1.tex}
	\subfile{parts/Galois.tex}
	\subfile{parts/Complexa.tex}
	\subfile{parts/Estadistica.tex}
	\subfile{parts/GeoDiferencial.tex}
	\subfile{parts/EDOS2.tex} %WEB TO' MOLONA: http://www-history.mcs.st-and.ac.uk/BiogIndex.html
